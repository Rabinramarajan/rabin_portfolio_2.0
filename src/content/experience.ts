...
export const experience: ExperienceRole[] = [
  {
    ...
    description:
      'Developing enterprise healthcare applications for a healthcare product company using Angular 22, TypeScript, SCSS and Angular Signals.',
    responsibilities: [
      'Building reusable, scalable UI components following Angular best practices and standalone component patterns.',
      'Integrating REST APIs with secure JWT authentication, and improving performance through lazy loading and optimised change detection.',
      'Performing code reviews, mentoring junior developers, and collaborating with Product Owners, Designers, QA Engineers and Backend Developers.',
    ],
    impact: [],
    technologies: ['Angular 22', 'TypeScript', 'SCSS', 'Angular Signals', 'RxJS', 'REST APIs', 'JWT'],
    milestone: 'Healthcare platforms',
    chapter: 'EXTEND',
...
export const careerHorizon: HorizonChapter[] = [
  ...
  },
  {
    ...
    body: "Developing enterprise healthcare applications for a healthcare product company using Angular 22, TypeScript, SCSS and Angular Signals.",
    tags: ["Angular 22", "TypeScript", "SCSS", "Angular Signals", "JWT"],
    tone: "live",
    location: "Chennai, India",
    monogram: "RS",
    logo: "https://www.rstacksolutions.com/favicon.ico?favicon.154iv7xvjl_ae.ico",
    achievements: [
      "Building reusable, scalable UI components on standalone component patterns.",
      "Integrating REST APIs with secure JWT authentication and optimised change detection.",
      "Reviewing code and mentoring junior developers inside a cross-functional product team.",
    ],
...
export const stackEvolution: StackTrack[] = [
  ...
  { id: 'signals', label: 'Angular Signals', enteredAt: '2026', source: 'rstack', active: true },
  { id: 'react', label: 'React / Next.js', enteredAt: '2026', source: 'toolkit', active: true },
  { id: 'jwt', label: 'JWT / RBAC', enteredAt: '2026', source: 'rstack', active: true },
];
...
export const careerMilestones: CareerMilestone[] = [
  ...
  },
  {
    id: 'consulting',
    year: '2026',
    event: 'Frontend Angular Consultant at RSTACK',
    why: 'Contract role building enterprise healthcare applications on Angular 22 and Signals — reusable component architecture, JWT-secured API integration and code review.',
  },
];
