...
const STAT_GLYPH: Record<string, string> = {
  ...
  badge: "M12 3l2.6 1.9 3.2-.1 1 3 2.6 1.9-1.6 2.8.6 3.2-3.1.8-2 2.5-3-1.2-3 1.2-2-2.5-3.1-.8.6-3.2L2.6 9.7l2.6-1.9 1-3 3.2.1z",
 ...
 * so the document keeps exactly one h1.
 */
export function ServicesHero({ headingLevel = "h1" }: { headingLevel?: "h1" | "h2" } = {}) {
        ...
        <ul className="sx-cards">
          {services.map((s, i) => (
            <motion.li
              ...
              transition={{ duration: duration.section, delay: (i % 3) * 0.06, ease }}
            >
              ...
              <p className="sx-card__body">{s.proposition}</p>
              <ArrowLink
